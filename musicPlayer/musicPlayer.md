...
`WebController.java`: 代理，真正进行收发消息的”工具人“。限于篇幅，其工作代码如附件`src_server.zip`内包含的原始代码，或者参考[Ethylene9160/useless_web_interface (github.com)](https://github.com/Ethylene9160/useless_web_interface)。
